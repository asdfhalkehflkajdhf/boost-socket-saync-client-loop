#bin 
g++  -Wall -g -o c  client.cpp -lboost_system -lboost_filesystem -lboost_thread-mt 

g++  -Wall -g -o c_2  client_2.cpp -lboost_system -lboost_filesystem -lboost_thread-mt -lpthread
g++  -Wall -g -o t  client_socket_t_test.cpp -lboost_system -lboost_filesystem -lboost_thread-mt -lpthread

g++  -Wall -g -o s  server.cpp -lboost_system -lboost_filesystem -lboost_thread-mt -lpthread

g++  -Wall -g -o chat_server  chat_server.cpp -lboost_system -lboost_filesystem -lboost_thread-mt -lpthread
g++  -Wall -g -o chat_client  chat_client.cpp -lboost_system -lboost_filesystem -lboost_thread-mt -lpthread


g++  -Wall -g -o f future.cpp -lboost_system -lboost_filesystem -lpthread
